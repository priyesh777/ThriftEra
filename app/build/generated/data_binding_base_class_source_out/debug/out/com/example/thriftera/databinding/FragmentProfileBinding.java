...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout linearAddProduct;
  ...
  @NonNull
  public final TextView tvAdminAddProduct;
  ...
  private FragmentProfileBinding(@NonNull NestedScrollView rootView, @NonNull ImageView arrow,
    ...
    this.linearAddProduct = linearAddProduct;
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linear_add_product;
      LinearLayout linearAddProduct = ViewBindings.findChildViewById(rootView, id);
      if (linearAddProduct == null) {
        break missingId;
      }
      ...
      id = R.id.tvAdminAddProduct;
      TextView tvAdminAddProduct = ViewBindings.findChildViewById(rootView, id);
      if (tvAdminAddProduct == null) {
        break missingId;
      }
