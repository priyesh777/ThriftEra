...
public final class BookedProductItemBinding implements ViewBinding {
  @NonNull
  ...
  private BookedProductItemBinding(@NonNull CardView rootView, @NonNull ImageView imageCartProduct,
      @NonNull CircleImageView imageCartProductColor, @NonNull CircleImageView imageCartProductSize,
      @NonNull View topLine, @NonNull TextView tvCartProductSize,
  ...
  @NonNull
  public static BookedProductItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BookedProductItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.booked_product_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BookedProductItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BookedProductItemBinding((CardView) rootView, imageCartProduct,
          imageCartProductColor, imageCartProductSize, topLine, tvCartProductSize,
          tvProductCartName, tvProductCartPrice);
    }
