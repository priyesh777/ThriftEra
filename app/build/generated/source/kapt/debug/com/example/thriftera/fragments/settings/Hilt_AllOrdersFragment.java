...
public abstract class Hilt_AllOrdersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AllOrdersFragment() {
    super();
  }

  Hilt_AllOrdersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AllOrdersFragment_GeneratedInjector) this.generatedComponent()).injectAllOrdersFragment(UnsafeCasts.<AllOrdersFragment>unsafeCast(this));
    }
  }
