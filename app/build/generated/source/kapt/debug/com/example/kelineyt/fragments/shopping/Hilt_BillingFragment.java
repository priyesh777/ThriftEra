...
public abstract class Hilt_BillingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BillingFragment() {
    super();
  }

  Hilt_BillingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BillingFragment_GeneratedInjector) this.generatedComponent()).injectBillingFragment(UnsafeCasts.<BillingFragment>unsafeCast(this));
    }
  }
