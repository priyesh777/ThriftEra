...
public abstract class Hilt_UserAccountFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserAccountFragment() {
    super();
  }

  Hilt_UserAccountFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserAccountFragment_GeneratedInjector) this.generatedComponent()).injectUserAccountFragment(UnsafeCasts.<UserAccountFragment>unsafeCast(this));
    }
  }
