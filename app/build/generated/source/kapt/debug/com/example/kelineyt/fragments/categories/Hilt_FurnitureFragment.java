...
public abstract class Hilt_FurnitureFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FurnitureFragment_GeneratedInjector) this.generatedComponent()).injectFurnitureFragment(UnsafeCasts.<FurnitureFragment>unsafeCast(this));
    }
  }
