...
public abstract class Hilt_IntroductionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IntroductionFragment() {
    super();
  }

  Hilt_IntroductionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IntroductionFragment_GeneratedInjector) this.generatedComponent()).injectIntroductionFragment(UnsafeCasts.<IntroductionFragment>unsafeCast(this));
    }
  }
