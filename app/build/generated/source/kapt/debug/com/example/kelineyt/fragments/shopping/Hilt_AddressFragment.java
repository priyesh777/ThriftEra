...
public abstract class Hilt_AddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddressFragment() {
    super();
  }

  Hilt_AddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddressFragment_GeneratedInjector) this.generatedComponent()).injectAddressFragment(UnsafeCasts.<AddressFragment>unsafeCast(this));
    }
  }
