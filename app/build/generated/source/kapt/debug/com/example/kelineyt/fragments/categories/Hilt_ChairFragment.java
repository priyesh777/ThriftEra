...
public abstract class Hilt_ChairFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChairFragment_GeneratedInjector) this.generatedComponent()).injectChairFragment(UnsafeCasts.<ChairFragment>unsafeCast(this));
    }
  }
