...
public abstract class Hilt_MainCategoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainCategoryFragment() {
    super();
  }

  Hilt_MainCategoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainCategoryFragment_GeneratedInjector) this.generatedComponent()).injectMainCategoryFragment(UnsafeCasts.<MainCategoryFragment>unsafeCast(this));
    }
  }
