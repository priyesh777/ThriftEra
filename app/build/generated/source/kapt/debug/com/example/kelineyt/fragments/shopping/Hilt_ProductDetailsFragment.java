...
public abstract class Hilt_ProductDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductDetailsFragment() {
    super();
  }

  Hilt_ProductDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDetailsFragment_GeneratedInjector) this.generatedComponent()).injectProductDetailsFragment(UnsafeCasts.<ProductDetailsFragment>unsafeCast(this));
    }
  }
