...
public abstract class Hilt_TableFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TableFragment_GeneratedInjector) this.generatedComponent()).injectTableFragment(UnsafeCasts.<TableFragment>unsafeCast(this));
    }
  }
