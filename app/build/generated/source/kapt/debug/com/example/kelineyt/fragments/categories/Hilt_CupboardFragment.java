...
public abstract class Hilt_CupboardFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CupboardFragment_GeneratedInjector) this.generatedComponent()).injectCupboardFragment(UnsafeCasts.<CupboardFragment>unsafeCast(this));
    }
  }
